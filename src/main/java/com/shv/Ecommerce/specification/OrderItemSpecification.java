package com.shv.Ecommerce.specification;
...
public class OrderItemSpecification {
    ...
    public static Specification<OrderItem> createdBeetween(LocalDateTime startDate, LocalDateTime endDate) {
        return ((root, query, criteriaBuilder) -> {
    ...
    /** Generate specification to filter order items by order id **/
